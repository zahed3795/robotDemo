...
Launch URL
    ...
    ${browser}               Read Cell Data By Coordinates    credentials    2    1  
    ${URL}                   Read Cell Data By Coordinates    credentials    3    1 
    ${Expected_Title}        Read Cell Data By Coordinates    credentials    4    1 
